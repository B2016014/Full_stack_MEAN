...
import { UntypedFormBuilder, FormBuilder , FormGroup , UntypedFormGroup, NgForm, Validators } from '@angular/forms';
...
export class DishDetailsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    .subscribe({
      ...
      .subscribe({
          next:resp => { console.log(resp); this.favorite = <boolean>resp.exists; },
